<?php 
    ...
    function ducray_init_posttypes(){
        ...
        register_post_type('products', $products_args);
		   ...
		   /*
         * Register Problems Post Type
         */
        $problems_args = array(
            'labels' => array(
                'name' => 'Problemy skórne',
                'singular_name' => 'Opisy problemów',
                'all_items' => 'Wszystkie opisy problemów',
                'add_new' => 'Dodaj nowy opis problemu',
                'add_new_item' => 'Dodaj nowy opis',
                'edit_item' => 'Edytuj opis problemu',
                'new_item' => 'Nowy opis problemu',
                'view_item' => 'Zobacz opis problemu',
                'search_items' => 'Szukaj w opisach problemów',
                'not_found' =>  'Nie znaleziono żadnych produktów',
        ...
        register_post_type('problems', $problems_args);
    ...
    function ducray_init_taxonomies(){
        ...
        register_taxonomy(
            'problem',
            array('products','problems','posts'),
            array(
                'hierarchical' => FALSE,
                'labels' => array(
                    'name' => 'Rodzaj problemu',
                    'singular_name' => 'Rodzaj problemu',
                    'search_items' =>  'Wyszukaj rodzaj problemu',
                    'popular_items' => 'Najpopularniejsze rodzaje problemu',
                    'all_items' => 'Wszystkie rodzaje problemu',
                    'most_used_items' => null,
                    'parent_item' => null,
                    'parent_item_colon' => null,
                    'edit_item' => 'Edytuj rodzaj problemu', 
                    'update_item' => 'Aktualizuj',
                    'add_new_item' => 'Dodaj nowy rodzaj problemu',
                    'new_item_name' => 'Nazwa rodzaju problemu',
                    'separate_items_with_commas' => 'Oddziel rodzaje przecinkiem',
                    'add_or_remove_items' => 'Dodaj lub usuń rodzaj',
                    'choose_from_most_used' => 'Wybierz spośród najczęściej używanych rodzajów',
                    'menu_name' => 'Rodzaj problemu',
                ),
                'show_ui' => true,
                'update_count_callback' => '_update_post_term_count',
                'query_var' => true,
